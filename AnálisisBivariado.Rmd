...
#########################################
# 1. Apoyo familiar vs ansiedad
#########################################

table(base_saludmental$apoyo_familia, base_saludmental$ansioso_nervioso)

ggplot(base_saludmental, aes(x = apoyo_familia, fill = ansioso_nervioso)) +
  geom_bar(position = "fill") +
  labs(title = "Apoyo familiar vs Ansiedad", y = "Proporción")


#########################################
# 2. Frecuencia de contacto social vs depresión
#########################################

table(base_saludmental$hablar_amigos_familia, base_saludmental$decaido_deprimido)

ggplot(base_saludmental, aes(x = hablar_amigos_familia, fill = decaido_deprimido)) +
  geom_bar(position = "fill") +
  labs(title = "Contacto social vs Depresión", y = "Proporción")


#########################################
# 3. Condiciones físicas de la vivienda vs tranquilidad
#########################################

table(base_saludmental$comodidad_vivienda, base_saludmental$tranquilo)

ggplot(base_saludmental, aes(x = comodidad_vivienda, fill = tranquilo)) +
  geom_bar(position = "fill") +
  labs(title = "Condiciones de vivienda vs Tranquilidad", y = "Proporción")


#########################################
# 4. Actividad física vs ansiedad/decaimiento
#########################################

# ansiedad
table(base_saludmental$freq_actividad_fisica, base_saludmental$ansioso_nervioso)

ggplot(base_saludmental, aes(x = freq_actividad_fisica, fill = ansioso_nervioso)) +
  geom_bar(position = "fill") +
  labs(title = "Actividad física vs Ansiedad", y = "Proporción")

# decaimiento/depresión
table(base_saludmental$freq_actividad_fisica, base_saludmental$decaido_deprimido)

ggplot(base_saludmental, aes(x = freq_actividad_fisica, fill = decaido_deprimido)) +
  geom_bar(position = "fill") +
  labs(title = "Actividad física vs Decaimiento", y = "Proporción")


#########################################
# 5. Exposición a violencia vs ansiedad/depresión
#########################################

table(base_saludmental$violencia_hogar, base_saludmental$ansioso_nervioso)

ggplot(base_saludmental, aes(x = violencia_hogar, fill = ansioso_nervioso)) +
  geom_bar(position = "fill") +
  labs(title = "Violencia en el hogar vs Ansiedad", y = "Proporción")

table(base_saludmental$violencia_hogar, base_saludmental$decaido_deprimido)

ggplot(base_saludmental, aes(x = violencia_hogar, fill = decaido_deprimido)) +
  geom_bar(position = "fill") +
  labs(title = "Violencia en el hogar vs Depresión", y = "Proporción")


#########################################
# 6. Problemas económicos vs depresión
# (está dentro de factores_preocupacion)
#########################################

base_saludmental$problemas_economicos <- ifelse(
  grepl("econ", base_saludmental$factores_preocupacion, ignore.case = TRUE),
  "Sí",
  "No"
)

table(base_saludmental$problemas_economicos, base_saludmental$decaido_deprimido)

ggplot(base_saludmental, aes(x = problemas_economicos, fill = decaido_deprimido)) +
  geom_bar(position = "fill") +
  labs(title = "Problemas económicos vs Depresión", y = "Proporción")


#########################################
# 7. Información clara de la alcaldía vs ansiedad
#########################################

table(base_saludmental$info_alcaldia_clara, base_saludmental$ansioso_nervioso)

ggplot(base_saludmental, aes(x = info_alcaldia_clara, fill = ansioso_nervioso)) +
  geom_bar(position = "fill") +
  labs(title = "Información clara de alcaldía vs Ansiedad", y = "Proporción")


#########################################
# 8. Sexo vs consumo de alcohol
#########################################

table(base_saludmental$sexo, base_saludmental$consumo_alcohol)

ggplot(base_saludmental, aes(x = sexo, fill = consumo_alcohol)) +
  geom_bar(position = "fill") +
  labs(title = "Sexo vs Consumo de alcohol", y = "Proporción")


#########################################
# 9. Edad vs problemas para dormir
#########################################

ggplot(base_saludmental, aes(x = edad, y = as.numeric(problemas_dormir))) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm") +
  labs(title = "Edad vs Problemas para dormir",
       y = "Problemas para dormir (numérico)")


#########################################
# 10. Diagnóstico COVID vs preocupación/ansiedad
#########################################

# preocupación viene en factores_preocupacion → detectar si menciona "COVID" o "salud"
base_saludmental$preocupacion_salud <- ifelse(
  grepl("salud|covid", base_saludmental$factores_preocupacion, ignore.case = TRUE),
  "Sí",
  "No"
)

table(base_saludmental$diagnosticado_covid, base_saludmental$preocupacion_salud)

ggplot(base_saludmental, aes(x = diagnosticado_covid, fill = preocupacion_salud)) +
  geom_bar(position = "fill") +
  labs(title = "Diagnóstico COVID vs Preocupación", y = "Proporción")

table(base_saludmental$diagnosticado_covid, base_saludmental$ansioso_nervioso)

ggplot(base_saludmental, aes(x = diagnosticado_covid, fill = ansioso_nervioso)) +
  geom_bar(position = "fill") +
  labs(title = "Diagnóstico COVID vs Ansiedad", y = "Proporción")
